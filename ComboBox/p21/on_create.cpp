...
style=WS_VISIBLE|WS_CHILD|WS_BORDER|CBS_DROPDOWN | CBS_HASSTRINGS | CBS_SIMPLE |WS_VSCROLL|CBS_HASSTRINGS;
hw=CreateWindow("combobox","combobox",style,X,Y,W,H,hwnd,(HMENU)IDD_COUNTRIES_CBO,0,0);
SendMessage(hw,WM_SETFONT,(UINT)hfont,0);

	char *g="AsasaS";
	SendMessage(hw,CB_ADDSTRING,0,(LPARAM)g);
