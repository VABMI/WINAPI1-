========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Taskb3
========================================================================


Diese Taskb3-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\Taskb3.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Taskb3.rc eingebunden.
...
Taskb3Dlg.h, Taskb3Dlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CTaskb3Dlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in Taskb3.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	Taskb3.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
