    ...
    public class ipv4_header
    {
        ...
        public string SourceAddress
        {
            set
            {
                ...
                {
                    this.source_address=System.BitConverter.ToUInt32(System.Net.IPAddress.Parse("127.0.0.1").GetAddressBytes(),0);
                }
            }
            get
            {
        ...
        public string DestinationAddress
        {
            set
            {
                try
                {
                    this.destination_address=System.BitConverter.ToUInt32(System.Net.IPAddress.Parse(value).GetAddressBytes(),0);
                }
                catch
                {
                    this.destination_address=System.BitConverter.ToUInt32(System.Net.IPAddress.Parse("127.0.0.1").GetAddressBytes(),0);
                }
            }
            get
            {
