...
namespace Network_Stuff
{
    public class FormWhois : CommonTelnetForm
    {
        ...
        {
            System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(FormWhois));
            ...
            // panel_control
            // 
            this.panel_control.Controls.Add(this.textBox_whois_server);
            this.panel_control.Controls.Add(this.radioButton_whois_use_following);
            this.panel_control.Controls.Add(this.radioButton_whois_auto_find);
            this.panel_control.Controls.Add(this.button_whois);
            this.panel_control.Controls.Add(this.textBox_whois_ip);
            this.panel_control.Controls.Add(this.label18);
        ...
        private void load_server_list(string filename)
        {
            ...
            this.whois_server_list=(Cserver_whois[])(Tools.Xml.XML_access.XMLDeserializeObject(filename,typeof(Cserver_whois[])));
        }
        private void save_server_list(string filename)
        {
            ...
            Tools.Xml.XML_access.XMLSerializeObject(filename,this.whois_server_list,typeof(Cserver_whois[]));
        }
