...
namespace Network_Stuff
{
    ...
    public class FormStat : System.Windows.Forms.Form
    {
        ...
        private System.Windows.Forms.StatusBar statusBar_information; 
        ...
        private void InitializeComponent()
        {
            ...
            this.statusBar_information = new System.Windows.Forms.StatusBar();
            this.SuspendLayout();
            // 
            // listView_stats
            // 
            ...
            // button_tcp_stat
            // 
            this.button_tcp_stat.Location = new System.Drawing.Point(8, 80);
            ...
            // button_udp_stats
            // 
            this.button_udp_stats.Location = new System.Drawing.Point(8, 104);
            ...
            // button_icmp_stats
            // 
            this.button_icmp_stats.Location = new System.Drawing.Point(8, 128);
            ...
            // button_ipnet_table
            // 
            this.button_ipnet_table.Location = new System.Drawing.Point(8, 56);
            ...
            // 
            this.statusBar_information.Location = new System.Drawing.Point(0, 320);
            this.statusBar_information.Name = "statusBar_information";
            this.statusBar_information.Size = new System.Drawing.Size(512, 22);
            this.statusBar_information.TabIndex = 11;
            // 
            // FormStat
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(512, 342);
            this.Controls.Add(this.statusBar_information);
            this.Controls.Add(this.textBox_refresh_interval);
            this.Controls.Add(this.checkBox_auto_refresh);
            this.Controls.Add(this.button_refresh_now);
            this.Controls.Add(this.button_ipnet_stats);
            this.Controls.Add(this.button_ipnet_table);
            this.Controls.Add(this.button_icmp_stats);
            this.Controls.Add(this.button_udp_stats);
            this.Controls.Add(this.button_udp_table);
            this.Controls.Add(this.button_tcp_stat);
            this.Controls.Add(this.button_tcp_table);
            this.Controls.Add(this.listView_stats);
        ...
        private int get_image_list_index(string full_path)
        {
            ...
            this.imageList.Images.Add(Tools.GUI.CIcon.GetIcon(full_path,false));
            return this.imageList.Images.Count-1;
        }
        // try catch each error cause they can be due to lacks of privilege, and so don't generate application error report for this
        ...
        public void get_tcp_table()
        {
            try
            {
                ...
                this.SuspendLayout();
                ListViewItem li;
                bool b_error_getting_process_path=false;
                ...
                if (this.is_xp_os())
                {
                    ...
                    for (int cpt=0;cpt<table.dwNumEntries;cpt++)
                    {
                        ...
                        if (table.table[cpt].pProcess.ProcessName!="System")
                        {
                            try
                            {
                            ...
                            catch
                            {
                                filename="";
                                img_index=this.get_image_list_index(default_system_app);
                                b_error_getting_process_path=true;
                            }
                        }
                    ...
                    if (b_error_getting_process_path)
                        this.statusBar_information.Text="Warning all processes paths couldn't be retrieved. This can be due to a privilege lacks.";
            ...
            {
                this.statusBar_information.Text="Error : "+e.Message;
            }
        }
        #endregion
        #region tcp_stats
        ...
        public void get_tcp_stats()
        {
            try
            {
                ListViewItem li;
                this.listView_stats.Items.Clear();
                iphelper.MIB_TCPSTATS table;
                if (this.is_xp_os())
                    table=iphelper.iphelper.GetTcpStatisticsEx();
                else
                    table=iphelper.iphelper.GetTcpStatistics();
        ...
        public void get_udp_stats()
        {
            ...
            {
                ListViewItem li;
                iphelper.MIB_UDPSTATS table;
                this.listView_stats.Items.Clear();
                if (this.is_xp_os())
                    table=iphelper.iphelper.GetUdpStatisticsEx();
                else
                    table=iphelper.iphelper.GetUdpStatistics();
        ...
        public void get_ip_stats()
        {
            try
            {
                ListViewItem li;
                this.listView_stats.Items.Clear();
                iphelper.MIB_IPSTATS table;

                if (this.is_xp_os())
                    table=iphelper.iphelper.GetIpStatisticsEx();
                else
                    table=iphelper.iphelper.GetIpStatistics();
        ...
        private void checkBox_auto_refresh_CheckedChanged(object sender, System.EventArgs e)
        {
            ...
            {
                if (!Tools.GUI.CCheck_user_interface_inputs.check_int(this.textBox_refresh_interval.Text))
                    return;
        ...
        {
            try // due to unsufficent privilege
            {
                ListViewItem lvi;
                for (int cpt=0;cpt<this.listView_stats.Items.Count;cpt++)
                {
            ...
            for (int cpt=0;cpt<this.listView_stats.Items.Count;cpt++)
            {
                ...
                if (lvi.Selected)
                {
                    ...
                    if (ret!=0)
                        ...
                        MessageBox.Show(this,
                            Tools.API.API_error.GetAPIErrorMessageDescription(ret),
                            "Error",
                            MessageBoxButtons.OK,
                            MessageBoxIcon.Error
                            );
        ...
        private void menuItem_edit_entry_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                mib_i.dwAddr=System.BitConverter.ToUInt32(System.Net.IPAddress.Parse(this.listView_stats.SelectedItems[0].Text).GetAddressBytes(),0);
            }
            catch
            {
