...
namespace Network_Stuff
{
    ...
    public class Form_packet_forge : System.Windows.Forms.Form
    {
        ...
        private System.Windows.Forms.TextBox textBox_ip_source_random_forbidden;
        ...
        {
            System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Form_packet_forge));
            this.groupBox_ip = new System.Windows.Forms.GroupBox();
            this.textBox_ip_source_random_forbidden = new System.Windows.Forms.TextBox();
            ...
            // groupBox_ip
            // 
            this.groupBox_ip.Controls.Add(this.textBox_ip_source_random_forbidden);
            this.groupBox_ip.Controls.Add(this.label51);
            this.groupBox_ip.Controls.Add(this.checkBox_ip_src_random);
            this.groupBox_ip.Controls.Add(this.numericUpDown_ip_ttl_min);
            this.groupBox_ip.Controls.Add(this.checkBox_ip_identification_random);
            this.groupBox_ip.Controls.Add(this.checkBox_ip_ttl_random);
            this.groupBox_ip.Controls.Add(this.label5);
            this.groupBox_ip.Controls.Add(this.textBox_ip_options_padding);
            this.groupBox_ip.Controls.Add(this.textBox_ip_dest);
            this.groupBox_ip.Controls.Add(this.textBox_ip_src);
            this.groupBox_ip.Controls.Add(this.numericUpDown_ip_header_length);
            this.groupBox_ip.Controls.Add(this.checkBox_ip_IHL_auto);
            this.groupBox_ip.Controls.Add(this.checkBox_ip_total_length_auto);
            this.groupBox_ip.Controls.Add(this.numericUpDown_ip_header_checksum);
            this.groupBox_ip.Controls.Add(this.numericUpDown_ip_protocol);
            this.groupBox_ip.Controls.Add(this.numericUpDown_ip_ttl);
            this.groupBox_ip.Controls.Add(this.numericUpDown_ip_fragment_offset);
            this.groupBox_ip.Controls.Add(this.label23);
            this.groupBox_ip.Controls.Add(this.label22);
            this.groupBox_ip.Controls.Add(this.numericUpDown_ip_identification);
            this.groupBox_ip.Controls.Add(this.numericUpDown_ip_total_length);
            this.groupBox_ip.Controls.Add(this.label21);
            this.groupBox_ip.Controls.Add(this.label20);
            this.groupBox_ip.Controls.Add(this.label19);
            this.groupBox_ip.Controls.Add(this.label18);
            this.groupBox_ip.Controls.Add(this.numericUpDown_ip_version);
            this.groupBox_ip.Controls.Add(this.label16);
            this.groupBox_ip.Controls.Add(this.label15);
            this.groupBox_ip.Controls.Add(this.label14);
            this.groupBox_ip.Controls.Add(this.checkBox_ip_header_checksum_auto);
            this.groupBox_ip.Controls.Add(this.label13);
            this.groupBox_ip.Controls.Add(this.label12);
            this.groupBox_ip.Controls.Add(this.label11);
            this.groupBox_ip.Controls.Add(this.label10);
            this.groupBox_ip.Controls.Add(this.comboBox_ip_flags_fragment_pos);
            this.groupBox_ip.Controls.Add(this.comboBox_ip_flags_fragment_type);
            this.groupBox_ip.Controls.Add(this.numericUpDown_ip_flag_bit0);
            this.groupBox_ip.Controls.Add(this.numericUpDown_ip_tos_bit7);
            this.groupBox_ip.Controls.Add(this.comboBox_ip_tos_relibility);
            this.groupBox_ip.Controls.Add(this.numericUpDown_ip_tos_bit6);
            this.groupBox_ip.Controls.Add(this.comboBox_ip_tos_throughtput);
            this.groupBox_ip.Controls.Add(this.comboBox_ip_tos_delay);
            this.groupBox_ip.Controls.Add(this.comboBox_ip_tos_precedence);
            this.groupBox_ip.Controls.Add(this.label9);
            this.groupBox_ip.Controls.Add(this.label8);
            this.groupBox_ip.Controls.Add(this.label7);
            this.groupBox_ip.Controls.Add(this.label6);
            this.groupBox_ip.Controls.Add(this.label4);
            this.groupBox_ip.Controls.Add(this.label3);
            this.groupBox_ip.Controls.Add(this.label2);
            this.groupBox_ip.Location = new System.Drawing.Point(0, 0);
            this.groupBox_ip.Name = "groupBox_ip";
            this.groupBox_ip.Size = new System.Drawing.Size(832, 224);
            this.groupBox_ip.TabIndex = 0;
            this.groupBox_ip.TabStop = false;
            this.groupBox_ip.Text = "Ip header";
            // 
            // textBox_ip_source_random_forbidden
            // 
            this.textBox_ip_source_random_forbidden.Location = new System.Drawing.Point(496, 176);
            this.textBox_ip_source_random_forbidden.Name = "textBox_ip_source_random_forbidden";
            this.textBox_ip_source_random_forbidden.Size = new System.Drawing.Size(320, 20);
            this.textBox_ip_source_random_forbidden.TabIndex = 109;
            this.textBox_ip_source_random_forbidden.Text = "10.0.0.1-10.255.255.255;192.168.0.0-192.168.255.255";
            // 
            // label51
            // 
            this.label51.Location = new System.Drawing.Point(632, 200);
            ...
            // 
            this.checkBox_ip_src_random.Location = new System.Drawing.Point(224, 176);
            this.checkBox_ip_src_random.Name = "checkBox_ip_src_random";
            this.checkBox_ip_src_random.Size = new System.Drawing.Size(280, 16);
            this.checkBox_ip_src_random.TabIndex = 107;
            this.checkBox_ip_src_random.Text = "Random; IP in the following list won\'t be generated";
            // 
            ...
            this.label5.Text = "Total Length (in byte)";
            // 
            // textBox_ip_options_padding
            // 
            this.textBox_ip_options_padding.Location = new System.Drawing.Point(120, 200);
            ...
            // textBox_ip_dest
            // 
            this.textBox_ip_dest.Location = new System.Drawing.Point(120, 152);
            ...
            // textBox_ip_src
            // 
            this.textBox_ip_src.Location = new System.Drawing.Point(120, 176);
            ...
            this.label15.Text = "Destination IP";
            // 
            // label14
            // 
            ...
            // groupBox_data
            // 
            this.groupBox_data.Controls.Add(this.button_stop);
            this.groupBox_data.Controls.Add(this.button_send);
            this.groupBox_data.Controls.Add(this.checkBox_data_looping_packets);
            this.groupBox_data.Controls.Add(this.numericUpDown_data_number_of_packets);
            this.groupBox_data.Controls.Add(this.label38);
            this.groupBox_data.Controls.Add(this.label37);
            this.groupBox_data.Controls.Add(this.textBox_data_value);
            this.groupBox_data.Controls.Add(this.checkBox_data_value_hexa);
            this.groupBox_data.Location = new System.Drawing.Point(0, 752);
            ...
            // groupBox_tcp
            // 
            this.groupBox_tcp.Controls.Add(this.checkBox_tcp_packet_details);
            this.groupBox_tcp.Controls.Add(this.panel_connection_helper);
            this.groupBox_tcp.Controls.Add(this.checkBox_tcp_data_offset_auto);
            this.groupBox_tcp.Controls.Add(this.label52);
            this.groupBox_tcp.Controls.Add(this.checkBox_tcp_connection_helper);
            this.groupBox_tcp.Controls.Add(this.checkBox_tcp_sequence_number_random);
            this.groupBox_tcp.Controls.Add(this.checkBox_tcp_src_port_random);
            this.groupBox_tcp.Controls.Add(this.numericUpDown_tcp_urgent_pointer);
            this.groupBox_tcp.Controls.Add(this.label32);
            this.groupBox_tcp.Controls.Add(this.numericUpDown_tcp_header_checksum);
            this.groupBox_tcp.Controls.Add(this.checkBox_tcp_header_checksum_auto);
            this.groupBox_tcp.Controls.Add(this.label31);
            this.groupBox_tcp.Controls.Add(this.numericUpDown_tcp_reserved);
            this.groupBox_tcp.Controls.Add(this.label30);
            this.groupBox_tcp.Controls.Add(this.textBox_tcp_options_padding);
            this.groupBox_tcp.Controls.Add(this.label29);
            this.groupBox_tcp.Controls.Add(this.numericUpDown_tcp_port_source);
            this.groupBox_tcp.Controls.Add(this.numericUpDown_tcp_port_dest);
            this.groupBox_tcp.Controls.Add(this.label28);
            this.groupBox_tcp.Controls.Add(this.label27);
            this.groupBox_tcp.Controls.Add(this.label26);
            this.groupBox_tcp.Controls.Add(this.label25);
            this.groupBox_tcp.Controls.Add(this.label24);
            this.groupBox_tcp.Controls.Add(this.label17);
            this.groupBox_tcp.Controls.Add(this.label1);
            this.groupBox_tcp.Controls.Add(this.checkBox_tcp_fin);
            this.groupBox_tcp.Controls.Add(this.checkBox_tcp_syn);
            this.groupBox_tcp.Controls.Add(this.checkBox_tcp_rst);
            this.groupBox_tcp.Controls.Add(this.checkBox_tcp_push);
            this.groupBox_tcp.Controls.Add(this.checkBox_tcp_ack);
            this.groupBox_tcp.Controls.Add(this.checkBox_tcp_urg);
            this.groupBox_tcp.Controls.Add(this.numericUpDown_tcp_window);
            this.groupBox_tcp.Controls.Add(this.numericUpDown_tcp_data_offset);
            this.groupBox_tcp.Controls.Add(this.numericUpDown_tcp_ack_num);
            this.groupBox_tcp.Controls.Add(this.numericUpDown_tcp_seq_num);
            this.groupBox_tcp.Location = new System.Drawing.Point(0, 232);
            ...
            // 
            this.panel_connection_helper.Controls.Add(this.label40);
            this.panel_connection_helper.Controls.Add(this.label53);
            this.panel_connection_helper.Controls.Add(this.label_tcp_connection_state);
            this.panel_connection_helper.Controls.Add(this.userControlPacketsView);
            ...
            // groupBox_udp
            // 
            this.groupBox_udp.Controls.Add(this.label36);
            this.groupBox_udp.Controls.Add(this.checkBox_udp_length_auto);
            this.groupBox_udp.Controls.Add(this.numericUpDown_udp_length);
            this.groupBox_udp.Controls.Add(this.numericUpDown_udp_checksum);
            this.groupBox_udp.Controls.Add(this.checkBox_udp_checksum_auto);
            this.groupBox_udp.Controls.Add(this.label35);
            this.groupBox_udp.Controls.Add(this.checkBox_udp_src_port_random);
            this.groupBox_udp.Controls.Add(this.numericUpDown_udp_src_port);
            this.groupBox_udp.Controls.Add(this.numericUpDown_udp_dest_port);
            this.groupBox_udp.Controls.Add(this.label33);
            this.groupBox_udp.Controls.Add(this.label34);
            this.groupBox_udp.Location = new System.Drawing.Point(0, 512);
            ...
            // groupBox_icmp
            // 
            this.groupBox_icmp.Controls.Add(this.textBox_icmp_gateway);
            this.groupBox_icmp.Controls.Add(this.numericUpDown_icmp_trans_timestamp);
            this.groupBox_icmp.Controls.Add(this.numericUpDown_icmp_recv_timestamp);
            this.groupBox_icmp.Controls.Add(this.numericUpDown_icmp_orig_timestamp);
            this.groupBox_icmp.Controls.Add(this.label50);
            this.groupBox_icmp.Controls.Add(this.label49);
            this.groupBox_icmp.Controls.Add(this.label48);
            this.groupBox_icmp.Controls.Add(this.numericUpDown_icmp_sequence_number);
            this.groupBox_icmp.Controls.Add(this.numericUpDown_icmp_identifier);
            this.groupBox_icmp.Controls.Add(this.label47);
            this.groupBox_icmp.Controls.Add(this.label46);
            this.groupBox_icmp.Controls.Add(this.label45);
            this.groupBox_icmp.Controls.Add(this.numericUpDown_icmp_pointer);
            this.groupBox_icmp.Controls.Add(this.label44);
            this.groupBox_icmp.Controls.Add(this.numericUpDown_icmp_checksum);
            this.groupBox_icmp.Controls.Add(this.checkBox_icmp_checksum_auto);
            this.groupBox_icmp.Controls.Add(this.label43);
            this.groupBox_icmp.Controls.Add(this.numericUpDown_icmp_unused);
            this.groupBox_icmp.Controls.Add(this.label42);
            this.groupBox_icmp.Controls.Add(this.label41);
            this.groupBox_icmp.Controls.Add(this.comboBox_icmp_code);
            this.groupBox_icmp.Controls.Add(this.comboBox_icmp_icmp_message);
            this.groupBox_icmp.Controls.Add(this.label39);
            this.groupBox_icmp.Location = new System.Drawing.Point(0, 600);
            ...
            this.Controls.Add(this.groupBox_icmp);
        ...
        private void my_send()
        {
            ...
            easy_socket.CMinMax[] forbidden_ip;
            int security_counter=0; // avoid infinte loop
            const int MAX_RANDOM_IP_TRY=200000;

            // get forbidden random ip table
            forbidden_ip=easy_socket.Cmultiple_elements_parsing.Parse_ip_limits(this.textBox_ip_source_random_forbidden.Text);
            if ((forbidden_ip==null)&&this.checkBox_ip_src_random.Checked)
                return;// return before enabling some flags

            // set the stop state to false
            this.set_stop_state(false);
            // check coonection helper status to start raw tcp server
            ...
            while((cpt<this.numericUpDown_data_number_of_packets.Value)&&(!this.b_stop))
            {
                ...
                if (this.checkBox_ip_src_random.Checked)
                {
                    ...
                    do
                    {
                        b_forbidden_ip=false;
                        iph.source_address=(UInt32)random.Next();
                        for (int cnt=0;cnt<forbidden_ip.Length;cnt++)
                        {
                            if ((iph.source_address>=forbidden_ip[cnt].min)&&(iph.source_address<=forbidden_ip[cnt].max))
                            {
                                b_forbidden_ip=true;
                                break;
                            }
                        ...
                        security_counter++;
                    }while (b_forbidden_ip&&(security_counter<MAX_RANDOM_IP_TRY));
                    if(security_counter>=MAX_RANDOM_IP_TRY)
                    {
                        MessageBox.Show(this,"Can't find a random IP corresponding to requirements after "+MAX_RANDOM_IP_TRY.ToString()+" tries.\r\nPacket forging will be stopped","Error",MessageBoxButtons.OK,MessageBoxIcon.Error);
                        break;
                    }
                }
                else
