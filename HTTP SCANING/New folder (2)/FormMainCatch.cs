...
using System.Windows.Forms;
	...
	public class FormMainCatch : System.Windows.Forms.Form
	{
		...
		public FormMainCatch(Exception e)
		{
            ...
            // splitting email author's name avoid this one to be scan by spam or virus programs
            this.str_email_author="jacquelin.potier";
            this.str_email_author+="@";
            this.str_email_author+="free.fr";
            ...
            this.textBox_report_data.Text+="Full Description: \r\n"+e.ToString();
