    ...
    public class UserControlPacketsView : System.Windows.Forms.UserControl
    {
        ...
        private void menuItem_save_all_Click(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                file_access.write(this.saveFileDialog.FileName,str);
            }
        }
        ...
        {
            XML_access.XMLSerializeObject(filename,(packet_view[])al.ToArray(typeof(packet_view)),typeof(packet_view[]));
        }
        ...
        {
            string str_file_content=file_access.read(filename);
            if (str_file_content=="")
                return;
            // split on \r\n
        ...
        private void load_xml(string filename)
        {
            try
            {
                ...
                packet_view[] pv=(packet_view[])XML_access.XMLDeserializeObject(filename,typeof(packet_view[]));
