    ...
    public class FormAddIPEntry : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Controls.AddRange(new System.Windows.Forms.Control[] {
                                                                          this.button_cancel,
                                                                          this.button_ok,
                                                                          this.comboBox_entry_type,
                                                                          this.label4,
                                                                          this.label3,
                                                                          this.label2,
                                                                          this.label1,
                                                                          this.textBox_adaptater_index,
                                                                          this.textBox_MAC,
                                                                          this.textBox_IP});
        ...
        private void button_ok_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                mib_i.dwAddr=(UInt32)(System.Net.IPAddress.Parse(this.textBox_IP.Text.Trim()).Address);
            }
            catch
            {
            ...
            if (error_code!=0)
            {
                str_msg=API_error.GetAPIErrorMessageDescription(error_code);
