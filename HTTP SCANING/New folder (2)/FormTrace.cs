    ...
    public class FormTrace : Network_Stuff.CommonTelnetForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.panel_data.Controls.AddRange(new System.Windows.Forms.Control[] {
                                                                                     ...
                                                                                     this.label17,
                                                                                     this.textBox_icmp_delay_for_reply,
        ...
        private bool get_values()
        {
            ...
            if (!CCheck_user_interface_inputs.check_int(this.textBox_icmp_delay_for_reply.Text))
                return false;
            if (!CCheck_user_interface_inputs.check_byte(this.textBox_icmp_start_with_hop.Text))
                return false;
            if (!CCheck_user_interface_inputs.check_byte(this.textBox_icmp_end_with_hop.Text))
                return false;
